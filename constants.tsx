...
export const PROJECTS: Project[] = [
  { id: 'heuristics-playground', title: 'Heuristics Playground', description: 'Interactive explorer of 20+ mental shortcuts — where they help, where they hurt, and how to deploy them deliberately.', tags: ['Science', 'UI'], link: 'https://yellowlights.ai/heuristics-playground/' },
  ...
  { id: 'intuition-duel', title: 'AI vs Human Intuition Duel', description: 'A head-to-head challenge pitting your gut instincts against an AI baseline. Reveals where human intuition excels — and where it reliably fails.', tags: ['Behavioral', 'Science'], link: 'https://yellowlights.ai/intuition-duel/' },
  ...
  { id: 'judgment-calibrator', title: 'The Judgment Calibrator', description: 'Measures the gap between your confidence and your accuracy. Build the habit of knowing what you know — and what you don\'t.', tags: ['Science', 'Logic'], link: 'https://yellowlights.ai/judgment-calibrator/' },
  ...
  { id: 'values-compass', title: 'Values Clarification Compass', description: 'Surfaces and ranks your actual values — not the ones you assume you hold — before a high-stakes decision demands you choose.', tags: ['Architecture', 'Behavioral'], link: 'https://yellowlights.ai/values-compass/' },
  ...
  { id: 'premortem-studio', title: 'Pre-Mortem & Red Team Studio', description: 'Assume the decision has already failed, then reconstruct why — before you\'ve committed and while you can still change course.', tags: ['Logic', 'Architecture'], link: 'https://yellowlights.ai/premortem-studio/' },
